    ...
    <section id="work-process" class="work-process">
      <div class="container">
        ...
        <div class="row content">
	      ...
	      la adecuada garantía que nuestros clientes exigen, cumpliendo con las normativas vigentes 
	      y respetando siempre el medio ambiente
            </p>
          </div>
        </div>
    ...
    <section id="clients" class="clients">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          ...
          <p>Estos son algunos de nuestros clientes que se encuentran satisfechos con nustros servicios.</p>
        </div>
