    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="fade-in">
        ...
        <div class="text-center">
          <h3>EXPERTOS EN CONTROL DE PLAGAS Y MANTENIMIENTOS PREVENTIVOS Y CORRECTIVOS CON GARANTÍA</h3>
        </div>
    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          ...
          <p>En Tecnofumiga te brindamos los siguientes servicios</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up">
            <div class="card" style="background-image: url(assets/img/sanitizacion.jpg);">
              <div class="card-body">
                <h5 class="card-title"><a href="">Sanitización</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="100">
            <div class="card" style="background-image: url(assets/img/areasverdes.jpg);">
              <div class="card-body">
                <h5 class="card-title"><a href="">Áreas Verdes</a></h5>
